...
class AJAXSelectField(Field):
    ...
    def process_data(self,value):
        ...
        This will be called during form construction by eht form's `kwargs` or `obj` argument.
    ...
    def process_formdata(self,valuelist):
        ...
        This will be called during form construction with data suuplied through the `formdata` argument.
...
class QuerySelectField(SelectFieldBase):
    """ Based ib WTForms QuerySelectField"""
    widget = widgets.Select()

    def __init__(self,label=None,validators=None,query_func=None,get_pk_func=None,get_label=None,
