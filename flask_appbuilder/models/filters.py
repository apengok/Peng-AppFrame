...
class BaseFilter(object):
    ...
    def __init__(self,column_name,datamodel,is_related_view=False):
        """
            ...
            :param column_name: Model field name
            :param datamodel: The datamodel access class
            :param is_related_view: Optional internal parameter to filter related views
        """
...
class BaseFilterConverter(object):
    """
        Base Filter Converter,all classes responsible for the association of columns and
        possible filters will inherit from this and override the conversion_table property.
    """
    conversion_table = ()
    """
        When implementing your own filters you just need to define the new filters,
        and register them overriding this property.This will map a column type to all possible filters.
        use something like this:
            ...
            ('is_string',[FilterCotains,
                FilterNotContains,
                FilterEqual,
                FilterNotEqual),
            ('is_integer',[FilterEqual,FilterNotEqual),
            )
    """
...
class Filters(object):
    ...
    def __init__(self,filter_converter,datamodel,search_columns=None):
        """
            :param filter_converter:Acepts BaseFilterConverter class
