...
__all__ = ['GenericFilterConverter','FilterNotContains','FilterEqual','FilterContains',
        'FilterIContains','FilterNotEqual','FilterGreater','FilterSmaller','FilterStartsWith']
